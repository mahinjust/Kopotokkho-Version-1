...
function Products() {
  ...
  return (
    <ProductPage>
    <RelatedProducts>
        <NewSingleRowItem header={'Related Products'} moreContents={'www.google.com'} content={products} perInstance={2}/>
    </RelatedProducts>
    <RecentProducts>
        <NewSingleRowItem header={'Recent Products'} moreContents={'www.google.com'} content={products} perInstance={2}/>
    </RecentProducts>
    </ProductPage>
  )
}
