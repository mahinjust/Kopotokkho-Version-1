  ...
  return (
    <FooterSec>
        <BotBar>
                ...
                <Info value={1} onClick={() => {
                    let caught = document.getElementById('1');
                    let arrow = document.getElementById('info');
                    let arrowDown = 'fa-chevron-down';
                    let arrowUp = 'fa-chevron-up';
                    if(caught.classList.contains('active')){
                        caught.classList.remove('active');
                        caught.classList.add('inactive');
                        arrow.classList.add(arrowDown);
                        arrow.classList.remove(arrowUp);
                    } else {
                        caught.classList.add('active');
                        caught.classList.remove('inactive');
                        arrow.classList.remove(arrowDown);
                        arrow.classList.add(arrowUp);
                    }
                }}>
                    <h3>Information <i id='info' className="fas fa-chevron-down"></i></h3>
                    <ExpandedFooter className="inactive" id='1'>
                        <p>About Us</p>
                        <p>Store Location</p>
                        <p>Contact Us</p>
                ...
                <Services value={2} onClick={() => {
                    let caught = document.getElementById('2');
                    let arrow = document.getElementById('service');
                    let arrowDown = 'fa-chevron-down';
                    let arrowUp = 'fa-chevron-up';
                    if(caught.classList.contains('active')){
                        caught.classList.remove('active');
                    ...
                    <h3>Our Service <i id='service' className="fas fa-chevron-down"></i></h3>
                    <ExpandedFooter className="inactive" id='2'>
                        <p>Privacy Policy</p>
                ...
                <Accounts value={3}  onClick={() => {
                    let caught = document.getElementById('3');
                    let arrow = document.getElementById('accounts');
                    let arrowDown = 'fa-chevron-down';
                    let arrowUp = 'fa-chevron-up';
                    if(caught.classList.contains('active')){
                        caught.classList.remove('active');
                    ...
                    <h3>Account Information <i id='accounts' className="fas fa-chevron-down"></i></h3>
                    <ExpandedFooter className="inactive" id='3'>
                        <p>My Account</p>
                        <p>My Cart</p>
                        <p>Checkout</p>
                        <p>My Wishlist</p>
